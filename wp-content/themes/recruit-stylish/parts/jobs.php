    ...
    <div class="jobs-grid">
      ...
      <article class="job-card reveal" itemscope itemtype="https://schema.org/JobPosting">
        ...
        <div class="job-card__footer">
          ...
          <a href="<?php echo esc_url( get_permalink( $job->ID ) ); ?>" class="btn btn--ghost btn--sm">
            View Role
            <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </a>
        </div>
      </article>
      <?php endforeach; ?>
