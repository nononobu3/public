...
function recruit_pop_setup() {
    load_theme_textdomain( 'recruit-pop', RECRUIT_POP_DIR . '/languages' );
    ...
    register_nav_menus( [
        'primary' => __( 'Primary Navigation', 'recruit-pop' ),
        'footer'  => __( 'Footer Navigation', 'recruit-pop' ),
    ] );
...
function recruit_pop_enqueue_assets() {
    ...
    wp_enqueue_style(
        'recruit-pop-fonts',
        'https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700;800&family=Noto+Sans+JP:wght@400;500;700&display=swap',
        [],
        null
    );
